...
const crossSpawn = __importStar(require("cross-spawn"));
...
const staged_1 = require("./git/staged");
...
class git {
    ...
    */
    ...
    isStaged(path) {
        return (0, staged_1.isStaged)(path, this.spawnOpt({ stdio: 'pipe' }));
    }
    /**
     * git checkout
     * @param branchName
    ...
    toString() {
        return (0, sbg_utility_1.jsonStringifyWithCircularRefs)(this);
    }
}
exports.git = git;
/** is current device is github actions */
