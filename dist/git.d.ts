...
import { isIgnoredOpt } from './functions/gitignore';
...
export declare class git {
  ...
  infos: {
    getIgnores: ({ cwd }: { cwd?: string }) => Promise<string[]>;
   ...
   * @returns
   */
  isIgnored(filePath: string, options?: isIgnoredOpt): Promise<boolean | import('./functions/gitignore').Return>;
  /**
   * git add
